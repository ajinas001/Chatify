        ...
        <div className=' bg-primary h-screen flex flex-col md:flex-row items-center justify-center'>
            ...
            <div className='bg-black rounded-3xl w-4/5 md:w-4/5 m-8 max-w-md justify-end  h-[60%] lg:h-[90%] flex flex-col  md:ms-54 overflow-hidden'>
                ...
                <div className="p-4 md:p-8 flex flex-col justify-end flex-1">
                    <Link href={'/register'}>
                        <button className='w-full bg-primary mb-4 rounded-full py-3 text-white font-bold'>Sign up free</button>
                    </Link>
                    <div className='flex justify-center'>
                        <img src='../images/google.png' className='h-6 w-6 m-3'>
                        </img>
                        <img src='../images/facebook.png' className='h-6 w-6 m-3'>
                        </img>
                    </div>
                    <div>

                        <input type='text' className='w-full px-4 sm:px-4 border border-gray-800  rounded-full py-3 mb-4 focus:outline-none text-start bg-transparent text-white placeholder-white' placeholder='Email' />
                        <input type='password' className=' w-full px-4 sm:px-4 border border-gray-800 rounded-full py-3 mb-4 focus:outline-none text-start bg-transparent text-white placeholder-white' placeholder='Password' />
                        <Link href={'/home'}>
